                    ...
                    columns: {
                        sws_api_tApi: {
                            ...
                            showDetails: function(row){
                                ...
                                var detailsContent = '';
                                var rData = row.data();
                                <span class="missing-if-branch" title="if path not taken" >I</span>if(row.data()[4] == 'Yes'){
<span class="cstat-no" title="statement not covered" >                                    detailsContent = '&lt;strong&gt;DEPRECATED&lt;/strong&gt;&lt;br/&gt;';</span>
<span class="cstat-no" title="statement not covered" >                                    alertClass = 'alert-danger';</span>
                                }
                                ...
                                detailsContent += row.data()[20] != '' ? <span class="branch-0 cbranch-no" title="branch not covered" >'&lt;strong&gt;Summary: &lt;/strong&gt;'+ row.data()[20] +'&lt;br/&gt;' </span>: '';
                                detailsContent += row.data()[21] != '' ? <span class="branch-0 cbranch-no" title="branch not covered" >'&lt;strong&gt;Description: &lt;/strong&gt;'+ row.data()[21] +'&lt;br/&gt;':</span> '';
                                detailsContent += row.data()[22] != '' ? <span class="branch-0 cbranch-no" title="branch not covered" >'&lt;strong&gt;Tags: &lt;/strong&gt;'+ row.data()[22] </span>: '';
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Jan 02 2018 10:47:01 GMT-0800 (PST)
</div>
</div>
