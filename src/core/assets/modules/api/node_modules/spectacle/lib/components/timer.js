...
function (_Component) {
  ...
  function Timer() {
    ...
    _this = _possibleConstructorReturn(this, (Timer.__proto__ || Object.getPrototypeOf(Timer)).apply(this, arguments));
    _this.handleStartTimer = _this.handleStartTimer.bind(_assertThisInitialized(_this));
    _this.handleStopTimer = _this.handleStopTimer.bind(_assertThisInitialized(_this));
